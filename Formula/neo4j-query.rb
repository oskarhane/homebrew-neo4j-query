class Neo4jQuery < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "2ce0d2425843d7428ac2894e57161eed66f2ac5a5964091e470973f8f21dfe83"
    end
    on_intel do
      url "https://github.com/oskarhane/homebrew-neo4j-query/releases/download/v#{version}/neo4j-query-x86_64-apple-darwin.tar.gz"
      sha256 "513007ca79442e46ab43af7db031e2e2d3f652aefb7f9a3dedae5d5487cf31c5"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "045d7579d63208ad5907b4b15bbabaa13e6e4d759a86284be063a5608c214860"
    end
    on_intel do
      ...
      sha256 "a281aad358145f0ca65c3b0a97db47d2d1859e747971ac7acb592fc9175c30de"
    end
  end
