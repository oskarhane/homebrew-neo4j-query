class Neo4jQuery < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "1c778fb1e6f9e4051c99f3c351497a3e805058096e4b31383d47e0dceedba592"
    end
    on_intel do
      url "https://github.com/oskarhane/homebrew-neo4j-query/releases/download/v#{version}/neo4j-query-x86_64-apple-darwin.tar.gz"
      sha256 "9a9e3b5d5edb56dcc26117f7e23bbee8c038ddf7be9e96983a627c604c79f7be"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "8c2be7a03be736815cbb8a85af2b980c1718508bfc1d305d256ae4e51f68170c"
    end
    on_intel do
      ...
      sha256 "387aab06a9151784439b8ffba137df7d09201196d1384a7f973b5f2ce199a382"
    end
  end
